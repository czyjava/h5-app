import type { DesignAssistantMessage, DesignAssistantSceneType, WorkItem } from './types';

interface AssistantWorkEntryParams {
  sceneType: DesignAssistantSceneType;
  currentSessionKey?: string;
  work: Pick<WorkItem, 'id' | 'templateId' | 'title'>;
}

export interface AssistantWorkEntryState {
  sceneType: DesignAssistantSceneType;
  workContext: { workId: string; templateId?: string };
  sessionKey: string;
